...
!!$  ------------------------------------------------------------------
!!$  Subroutine to calculate the number of ghost particles and to 
!!$    define an array that linking real and ghost particles
!!$
!!$    np-- number of particles                                     [in]
!!$    nv-- number of virtual boundary particles                    [in]
!!$    ng-- number of ghost particles                               [in]
...
end Subroutine ghost_particles
