subroutine link_list(nt, x, h, niac, pair_i, pair_j)

!!$-------------------------------------------------------------------
!!$ Subroutine to calculate the interaction pairs between the particles
!!$ the pairs are determined by by using a sorting grid linked list  
!!$	
...
!!$ The index vector is used to store the number of particles in each grid cell
  do i = 1, nt
     do d = 1, dim
